...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		duplicatecompanynameElement.sendKeys("TCS");
		
		WebElement duplicatefirstnameElement=driver.findElement(By.id("createLeadForm_firstName"));
		duplicatefirstnameElement.clear();
		duplicatefirstnameElement.sendKeys("Mithamadhu");
		
		WebElement createduplicateElement=driver.findElement(By.name("submitButton"));
		createduplicateElement.click();
