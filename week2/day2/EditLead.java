...
public class EditLead {
	...
	public static void main(String[] args) {
		...
		WebElement editimportantnoteElement=driver.findElement(By.id("updateLeadForm_importantNote"));
		editimportantnoteElement.sendKeys("abc xyz");
		
		WebElement updateElement=driver.findElement(By.name("submitButton"));
		updateElement.click();
		
		System.out.println("The title of the resulting page "+driver.getTitle());
